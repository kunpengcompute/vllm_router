...
<tr id="row1930811171892"><th class="firstcol" valign="top" width="42.17%" id="mcps1.1.3.3.1"><p id="p2030912172097"><a name="p2030912172097"></a><a name="p2030912172097"></a>BoostKit 版本号</p>
</th>
...
| 文档名称 | 内容简介 | 交付方式|
| ------------ | ------------ | ---|
| 版本说明书| 提供vLLM-Router每个发布版本的基础信息和特性更新信息。 | 开源仓 |
| 用户指南| 提供vLLM-Router快速上手指导。 | 开源仓 |
| API参考 | 提供vLLM-Router的接口说明。 | 开源仓 |

### 获取文档的方法

您可以通过访问[开源仓](https://gitcode.com/boostkit/vllm_router)浏览和获取相关文档。
