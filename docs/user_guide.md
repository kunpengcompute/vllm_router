...
## 安装vLLM推理软硬件环境
以鲲鹏920新型号CPU+沐曦的曦云C500 GPU * 8硬件环境为例，参考沐曦官方的[文档](https://developer.metax-tech.com/api/client/document/preview/781/index.html)安装驱动、固件和vLLM推理容器后，即可进行vLLM-Router的部署。
