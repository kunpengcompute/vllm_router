...
[benchmark_utils.py](https://github.com/vllm-project/vllm/blob/v0.8.2/benchmarks/benchmark_utils.py)这4个文件。
在这4个文件的存放路径下执行以下命令启动性能测试
```
...
| port | int  | -   |路由服务监听端口| 有效端口范围：1 ~ 65535|
